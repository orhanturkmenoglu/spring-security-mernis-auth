...
public class DEAKPSPublicSoap12
{
    ...
    public DEAKPSPublicSoap12()
    {
    }

    public DEAKPSPublicSoap12(String url)
    {
        this.url=url;
    }

    public DEAKPSPublicSoap12 (String url,DEAConnectionProvider connectionProvider) {
        this.url=url;
    ...
    protected DEARequestResultHandler createRequestResultHandler()
    {
        DEARequestResultHandler handler = new DEARequestResultHandler(DEASoapVersion.v1_2);
        return handler;
    }
    
    private org.w3c.dom.Document createTCKimlikNoDogrulaRequest(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili,DEARequestResultHandler __handler) throws java.lang.Exception
    {
    ...
    {
        DEARequestResultHandler __handler =createRequestResultHandler();
        ...
        org.w3c.dom.Node __result=DEAHelper.getResult(__handler.getOutputBody(), "TCKimlikNoDogrulaResult",false);
        if(__result!=null)
        {
            return DEAHelper.toBoolFromString(((org.w3c.dom.Element)__result).getTextContent());
        }
        return null;
    }
    protected void sendRequest(String soapAction,org.w3c.dom.Document soapBody, DEARequestResultHandler handler) throws java.lang.Exception
    {
        ...
        String __requestBody=DEAHelper.getStringFromDocument(soapBody);
        if(enableLogging)
        {
            System.out.println("requestDump: "+__requestBody);
        }
        DEAResponseData response=connectionProvider.sendRequest(url,__requestBody, __headers,handler, __contentType);
        if(enableLogging)
        {
