...
public class RGLKPSPublicSoap
{
    ...
    public RGLKPSPublicSoap()
    {
    }

    public RGLKPSPublicSoap(String url)
    {
        this.url=url;
    }

    public RGLKPSPublicSoap (String url,RGLConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        RGLRequestResultHandler handler = new RGLRequestResultHandler(RGLSoapVersion.v1_1);
        return handler;
    }
