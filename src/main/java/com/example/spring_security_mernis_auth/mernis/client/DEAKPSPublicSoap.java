...
public class DEAKPSPublicSoap
{
    ...
    public DEAKPSPublicSoap()
    {
    }

    public DEAKPSPublicSoap(String url)
    {
        this.url=url;
    }

    public DEAKPSPublicSoap (String url,DEAConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        DEARequestResultHandler handler = new DEARequestResultHandler(DEASoapVersion.v1_1);
        return handler;
    }
